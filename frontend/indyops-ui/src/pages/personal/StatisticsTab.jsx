...
// Mining profit report (refine → Jita value → tax) by category and period. The
// raw historical ledger lives in the Journal tab; the knobs that drive this report
// (tax %, price basis, refine yield) live in the Settings tab.
export default function StatisticsTab({ charId }) {
